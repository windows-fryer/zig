...
pub const X86 = enum(usize) {
    ...
    pub fn call0(number: @This()) ReturnCode {
    ...
    pub fn call1(number: @This(), arg1: Arg) ReturnCode {
        return asm volatile ("int $0x80"
            : [ret] "={eax}" (-> ReturnCode),
            : [number] "{eax}" (number),
              [arg1] "{ebx}" (arg1),
    ...
    pub fn call2(number: @This(), arg1: Arg, arg2: Arg) ReturnCode {
        return asm volatile ("int $0x80"
            : [ret] "={eax}" (-> ReturnCode),
            : [number] "{eax}" (number),
              [arg1] "{ebx}" (arg1),
    ...
    pub fn call3(number: @This(), arg1: Arg, arg2: Arg, arg3: Arg) ReturnCode {
        return asm volatile ("int $0x80"
            : [ret] "={eax}" (-> ReturnCode),
            : [number] "{eax}" (number),
              [arg1] "{ebx}" (arg1),
    ...
    pub fn call4(number: @This(), arg1: Arg, arg2: Arg, arg3: Arg, arg4: Arg) ReturnCode {
        return asm volatile ("int $0x80"
            : [ret] "={eax}" (-> ReturnCode),
            : [number] "{eax}" (number),
              [arg1] "{ebx}" (arg1),
    ...
    pub fn call5(number: @This(), arg1: Arg, arg2: Arg, arg3: Arg, arg4: Arg, arg5: Arg) ReturnCode {
        return asm volatile ("int $0x80"
            : [ret] "={eax}" (-> ReturnCode),
            : [number] "{eax}" (number),
              [arg1] "{ebx}" (arg1),
